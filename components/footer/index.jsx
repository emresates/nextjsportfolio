    ...
    <>
      ...
      <div className="mb-20 flex items-center justify-center px-6 xl:px-20 pb-2 pt-4 md:justify-between xl:mb-0">
        <div className="hidden items-center md:flex">
          ...
          >
            If you are lazy to scroll up just click this text :))
          </p>
        </div>

        <div className="flex flex-col items-center text-right text-sm font-medium uppercase leading-snug tracking-widest text-gray-100 md:flex-row">
